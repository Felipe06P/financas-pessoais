...
# ========= Layout ========= #
layout = dbc.Col([
                html.H3("Orçamento Pessoal", className="text-white",),
                html.P("By Felipe Pereira", className="text-white"),
                html.Hr(),
    # ========= Secão perfil ========= #
                dbc.Button(id='botao_avatar',
                        children=[html.Img(src='/assets/img_hom.png', id= 'avatar_change', alt='Avatar', className='perfil_avatar',style={'margin-left': '20px'} )
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                    dbc.Label("Descrição: "),
                                    dbc.Input(placeholder="Ex.: Salario, redimentos...", id="txt-receita"),
                            ], width=6), 
                            dbc.Col([
                                    dbc.Label("Valor: "),
                                            ...
                                            dbc.Row([
                                                ...
                                                dbc.Col([
                                                    ...
                                                    dbc.Checklist(
                                                        ...
                                                        options=[{"label": i, "value": i} for i in cat_receita],
                                                        value=[],
                                                        label_checked_style={"color": "warning"},
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                    dbc.Label("Descrição: "),
                                    dbc.Input(placeholder="Ex.: combustivel, alimentação...", id="txt-despesa"),
                            ], width=6), 
                            dbc.Col([
                                    dbc.Label("Valor: "),
...
# Seçao Nav
                ...
                dbc.Nav(
                    [
                    dbc.NavLink("Dashbord", href="/dashboards", active="exact"),
...
@app.callback(
    ...
    [
    State("input-add-despesa", "value"), #txt
    State('checklist-selected-style-despesa', 'value'), #check_delete
    State('stored-cat-despesas', 'data') #data
    ]
)
...
@app.callback(
    ...
    [
    State("input-add-receita", "value"), #txt
    State('checklist-selected-style-receita', 'value'), #check_delete
    State('stored-cat-receitas', 'data') #data
    ]
)
def add_category(n, n2, txt, check_delete, data):
    #import pdb
